                                            ...
                                            return (
                                                <div key={item1 + index1} className="item">
                                                    <div className="select_wrap" onClick={this.selectItem.bind(this, item1)}>
                                                        {item1.checked && (<img className="select" src="https://i.loli.net/2020/03/05/2ODunK73vlaHhIw.png" alt=""/>
                                                        )}
                                                        {!item1.checked && (<img className="select" src="https://i.loli.net/2020/03/05/zaBLDGlk2dCUwZQ.png" alt=""/>)}
                                                    </div>
